...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1IjoiYW5lazEzIiwiYSI6ImNqbmJ6azA3dTF0eW0zcXJmcmRtZWwzYmkifQ.d6R9tHiHEnlzb8CZUVHZxw',
    maxZoom: 18,
...
createRestaurantHTML = (restaurant) => {
  ...
  image.setAttribute('alt', 'Photo extract from ' + restaurant.name + ' restaurant');
...
//Registering the service worker using the default scope
